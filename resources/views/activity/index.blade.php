                                ...
                                <div class="card-body">
                                    <div class="toolbar mb-3">
                                        <form method="GET" action="{{ route('log.index') }}"
                                            ...
                                            {{-- Export: filter yang aktif ikut dibawa ke export --}}
                                            <a href="{{ route('log.export', array_filter([
                                            ...
                                            @forelse ($logs as $log)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @endphp
                                                        <span class="badge badge-{{ $moduleColor }}">{{ $log->module }}</span>
                                                    </td>
                                                    <td>
                                                        @php
                                                        ...
                                                        @endphp
                                                        <span class="badge badge-{{ $actionColor }}">{{ $log->action }}</span>
                                                    </td>
